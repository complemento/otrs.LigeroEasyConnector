package Kernel::System::GenericAgent::OtrsIntegrationRemoteTicketUpdate;
...
sub Run {
    ...
    $Kernel::OM->Get('Kernel::GenericInterface::Requester')->Run(
        ...
        Invoker      => $Kernel::OM->Get('Kernel::Config')->Get('OTRSIntegration::InvokerNameRemoteTicketUpdate'),
        Data         => \%Param
    );
